            ...
            <div className='w-full h-full px-3 md:px-0 md:w-3/4 md:h-5/6 bg-white  absolute flex flex-col items-center py-10 xl:h-5/6 xl:py-5'>
                ...
                <div className="w-full h-full flex flex-col items-center">
                    ...
                    <div className='w-full h-full flex flex-col items-center lg:justify-center'>
                        <form ref={form} onSubmit={handleSubmission} className='w-full h-full lg:h-3/4 lg:w-5/6 flex flex-col justify-center px-16 lg:px-8'>
                            <label htmlFor='Name'className='text-xl font-semibold  text-violet-900'> Name
                                <input type='text' name='name' placeholder='Your Name' className='block w-full px-3 py-1 text-left mb-2 mt-1 border-b-2'/>
                            </label>
                            <label htmlFor='email' className='text-xl font-semibold  text-violet-900'> Your email*
                                <input type='email' name='email' placeholder='Your Email Address' className='block w-full px-3 py-1 text-left mb-2 mt-1 border-b-2'/>
                            </label>
                            <label htmlFor='message' className='text-xl font-semibold text-violet-900 mb-1'> Message*
                                <textarea name='message' placeholder='Enter your message' className='block w-full px-3 py-3 text-left mb-2 mt-1 border-b-2'></textarea>
                            </label>
                            <div>
