...
export const about = "Front-end Engineer with strong analytic background and desire to build functional and aesthetically pleasing user interfaces without sacrificing business objectives. Ability to deliver well-structured pixel-perfect implementation of user interface/user experience designs."