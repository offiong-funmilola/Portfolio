...
function Footer() {
  return (
    <>
    <div className='w-screen  h-full mt-10 md:h-[50vh] bg-violet-900 flex flex-col justify-center py-8 px-16 items-center md:mt-0 md:flex-row md:justify-between md:px-12 lg:px-16 '>
